...
public class DataDrivenTesting_SWD_Test {
	...
	public void test() throws IOException {
		...
		String filepath = "C:\\Users\\javie\\Desktop\\Test.xlsx";

		String searchText = readFile.getCellValue(filepath, "Sheet1", 3, 0);
		...
		writeFile.writeCellValue(filepath, "Sheet1", 3, 1, resultText);
